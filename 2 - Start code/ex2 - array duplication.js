...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "Nguyen", batch: "9", age: 20 },
  { firstName: "Binh", lastName: "Tran", batch: "7", age: 22 },
  { firstName: "Cam", lastName: "Le", batch: "8", age: 21 },
  { firstName: "An", lastName: "Pham", batch: "10", age: 19 }, // No more duplicate first name
];
...
updateStudentAge("An","Pham","10", 30);
